...
; Definitions
LCD_DAT     EQU PORTB ;PORTB LCD data port, bits - PB7,...,PB0
LCD_CNTR    EQU PTJ   ;PTJ LCD control port, bits - PE7(RS),PE4(E)
LCD_E       EQU $80   ;$80 LCD E-signal pin
LCD_RS      EQU $40   ;$40 LCD RS-signal pin
...
bowOFF      JSR putcLCD
            LDAA  #$20            ; output a space character in ASCII
            JSR   putcLCD
...
INT2BCD         XGDX                  ; Save the binary number into X
                ...
                XGDX                  ; if not zero, get the binary number back to D as dividend
