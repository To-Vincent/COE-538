...
ROMStart    EQU  $3000            ; absolute address to place my code/constant data
...
FIRSTNUM    FCB $41
SECONDNUM   FCB $39
mem1        RMB 2                 ; memory 1 16 bit placeholder
mem2        RMB 2                 ; memory 2 16 bit placeholder
mem3        RMB 2                 ; memory 3 16 bit placeholder
mem4        RMB 2                 ; memory 4 16 bit placeholder
mem5        RMB 2                 ; memory 5 16 bit placeholder
...
clrLCD      LDAA #$01             ; clear cursor and return to home position
            JSR cmd2LCD           ; -"-
            LDY #10000            ; wait until "clear cursor" command is complete
            JSR del_50us          ; -"-
            RTS
